...
|---|---|---|
| `git_utils` | `shared.git.git_utils` | `checkout_branch`, `create_feature_branch`, `merge_branch`, `branch_diff`, `commit_paths`, `initialize_new_repo`, `get_head_sha`, `resolve_remote_branch_sha`, `DEVELOPMENT_BRANCH`, … |
