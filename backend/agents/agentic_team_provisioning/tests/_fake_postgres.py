...
``get_conn`` on ``agentic_team_provisioning.assistant.store``,
``agentic_team_provisioning.infrastructure``, and
``agentic_team_provisioning.testing.store`` to redirect to this fake.
