...
class AgenticTeamStore:
    ...
    def create_team(self, name: str, description: str = "") -> AgenticTeam:
        ...
        # Best-effort, non-blocking: link the team to the default profile.
        record_association_async(ArtifactType.AGENTIC_TEAM, "agentic_team_provisioning", team_id, label=name)
        return AgenticTeam(
            team_id=team_id,
            name=name,
