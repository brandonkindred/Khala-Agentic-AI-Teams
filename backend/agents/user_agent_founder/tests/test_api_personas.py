...
def test_list_personas_returns_db_rows(fake_persona_store):
    from user_agent_founder.api.main import list_personas
...
def test_create_persona_returns_201_with_payload(fake_persona_store):
    from user_agent_founder.api.main import CreatePersonaRequest, create_persona
...
def test_get_persona_returns_persona(fake_persona_store):
    from user_agent_founder.api.main import get_persona
...
def test_update_persona_writes_partial_fields(fake_persona_store):
    from user_agent_founder.api.main import UpdatePersonaRequest, update_persona
...
def test_delete_persona_204(fake_persona_store):
    from user_agent_founder.api.main import delete_persona
...
def test_testable_teams_lists_adapter_registry_keys():
    from user_agent_founder.api.main import list_testable_teams
...
def test_slugify_persona_name_drops_non_alnum_and_truncates():
    from user_agent_founder.api.main import _slugify_persona_name
