"""Unit tests for Planning phases (mocked LLM and adapters)."""
...
from planning_team.phases import (  # noqa: E402
    run_discovery,
    run_intake,
    run_requirements,
    run_synthesis,
)
from planning_team.tests.conftest import make_llm, multi_heading_doc  # noqa: E402
