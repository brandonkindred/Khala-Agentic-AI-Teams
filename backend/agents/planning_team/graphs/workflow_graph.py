"""Planning workflow graph — sequential 6-phase pipeline.
...
adapters to external services (PRA, Market Research, AI Systems).
"""
...
def build_workflow_graph() -> Graph:
    """Build the Planning sequential workflow graph.
