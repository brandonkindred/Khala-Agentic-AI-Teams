...
def test_stale_owner_mutation_rejected_after_reclaim_by_second_owner(
    ...
    from agent_provisioning_team.shared.agent_lock import AgentLockStore, StaleFencingTokenError
    from agent_provisioning_team.temporal import activities

    monkeypatch.setenv("AGENT_CACHE", str(tmp_path))
    monkeypatch.setattr("agent_provisioning_team.temporal.constants.LOCK_TTL_S", 100)
    ...
    with caplog.at_level(logging.ERROR, logger="agent_provisioning_team.shared.agent_lock"):
