"""Tests for Planning V3 fail-closed answer resolution and the handoff question fields."""

from __future__ import annotations

import pytest

from planning_v3_team.models import AnsweredQuestion, HandoffPackage, OpenQuestion
from planning_v3_team.orchestrator import _resolve_pra_answers
