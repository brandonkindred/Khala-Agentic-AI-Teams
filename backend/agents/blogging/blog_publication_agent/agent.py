    ...
    def run_revision_loop(
        ...
        *,
        ...
        for iteration in range(self.max_revision_loops):
            ...
            # tooling fallback or a clean pass; after the first iteration, an
            # approved editor result also ends the loop so we do not keep calling
            # revise() with no actionable items for max_revision_loops.
