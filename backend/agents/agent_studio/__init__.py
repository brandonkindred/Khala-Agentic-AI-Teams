...
* a **per-agent authoring assistant** (:mod:`agent_studio.assistant`) that
  co-authors a single :class:`~agent_studio.models.AgentDefinition` via LLM chat,
...
Conversation state is held in-process (:mod:`agent_studio.store`); durable
