...
from software_engineering_team.coding_team.engine_provider import (
    get_engine_provider,
    set_engine_provider,
)
...
def test_registry_set_get_and_clear(monkeypatch) -> None:
    ...
    monkeypatch.setattr("software_engineering_team.coding_team.engine_provider._provider", None)
