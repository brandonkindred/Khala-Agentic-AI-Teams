"""Tests for frontend_code_v2_team.phases._profile.run_review and helpers."""
...
def _stub_coordinator(monkeypatch, *, approved: bool = True, issues=None) -> None:
    ...
    from software_engineering_team.frontend_code_v2_team.phases import _profile as review_mod
