...
def test_fe_run_llm_review_defaults_language_to_profile_default(monkeypatch):
    ...
    placeholder."""
    from software_engineering_team.code_review_agent.models import CodeReviewOutput
    from software_engineering_team.codegen_team.stacks.frontend.profile import _run_llm_review
    from software_engineering_team.shared import v2_review_bindings as review_mod
...
def test_fe_run_review_clean(monkeypatch, tmp_path: Path):
    from software_engineering_team.codegen_team.stacks.frontend.profile import run_review
...
def test_fe_run_qa_agent_chunks_large_input_without_dropping_tail():
    ...
    from software_engineering_team.codegen_team.stacks.frontend.profile import _run_qa_agent
...
def test_fe_run_security_agent_chunks_large_input_without_dropping_tail():
    ...
    from software_engineering_team.codegen_team.stacks.frontend.profile import _run_security_agent
