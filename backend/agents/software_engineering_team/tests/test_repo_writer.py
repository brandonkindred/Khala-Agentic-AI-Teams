...
def test_write_agent_output_returns_no_files_to_write_for_dict_with_empty_files(tmp_path: Path) -> None:
    ...
    ok, msg = write_agent_output(tmp_path, {"files": {}, "suggested_commit_message": "x"}, subdir="")
    assert ok is False
    assert msg == NO_FILES_TO_WRITE_MSG
