"""Tests for ``shared.llm_recovery.recovery``.
...
def test_looks_like_path_basics() -> None:
    from shared.llm_recovery.recovery import _looks_like_path
...
def test_extract_files_empty() -> None:
    from shared.llm_recovery.recovery import extract_files_from_content
