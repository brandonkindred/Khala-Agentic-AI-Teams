...
_CODE_REVIEW_CRITERIA = (
    ...
    "explicit: false for a defect this change added or modified, true only for an unrelated defect "
    "in surrounding code the change did not touch. This criterion covers new complexity and new "
