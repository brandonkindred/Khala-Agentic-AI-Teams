...
_SHARED_OUTPUT_SECTION = (
    ...
    "change-surface marker or the task/diff description. Set true when you cannot tell "
    "whether the code predates this change -- do not guess a finding into scope. The downstream posting "
...
_SHARED_REVIEW_POLICY = (
    ...
    "description. Set true when uncertain -- do not guess a defect into scope. The downstream "
