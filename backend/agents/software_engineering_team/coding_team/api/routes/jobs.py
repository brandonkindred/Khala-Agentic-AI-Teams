...
from software_engineering_team.coding_team.agent_status import build_agent_statuses
...
def _temporal_dispatch(job_id: str, request: RunRequest) -> bool:
    ...
    if not is_temporal_enabled():
        return False
    try:
        from software_engineering_team.coding_team.temporal.start_workflow import (
