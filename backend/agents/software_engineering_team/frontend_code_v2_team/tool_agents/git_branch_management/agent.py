...
class GitBranchManagementToolAgent:
    """Manages feature branch creation, incremental commits during execution, and merge to development."""
    ...
    def create_feature_branch(
        ...
        """Create feature branch from development and checkout it. Returns (success, branch_name or None)."""
    ...
    def deliver(self, phase_inp: ToolAgentPhaseInput) -> ToolAgentPhaseOutput:
        """If feature_branch_name is set: commit remaining, merge to development, delete branch. Else create branch, write files, commit, merge."""
