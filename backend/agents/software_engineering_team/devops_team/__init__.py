...
completion packages with acceptance-criteria trace, and the structured,
write-capable run_task() entry point the coding-team's opt-in devops handoff
(CODING_TEAM_DEVOPS_ROUTING) uses.
"""
