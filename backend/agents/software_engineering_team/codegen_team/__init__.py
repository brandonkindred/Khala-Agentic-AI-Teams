...
tasks through the same 5-phase cycle: Planning -> Execution -> Review ->
Problem-solving -> Deliver, selected at construction time by a
``stack: Literal["backend", "frontend"]`` parameter rather than by two
separate team implementations.
