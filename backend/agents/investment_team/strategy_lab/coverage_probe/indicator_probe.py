...
# SubconditionVisitor lives in subcondition_visitor.py; imported here
# (rather than at the top of the file) because that module imports back
# from this one for the operand-building and name-binding helpers above,
# most of which are defined well past this point in the file. Placing
# the import at the end guarantees this module's namespace is complete
# before subcondition_visitor.py resolves its own imports, avoiding a
# partial-init circular import. subcondition_visitor.py should only ever
# be imported indirectly, through this module.
from investment_team.strategy_lab.coverage_probe.subcondition_visitor import (  # noqa: E402
    SubconditionVisitor,
)
