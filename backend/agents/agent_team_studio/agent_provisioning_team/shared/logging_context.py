...
def install_filter(logger_name: str = "agents.agent_team_studio.agent_provisioning_team") -> None:
    ...
    logging.getLogger("agent_team_studio.agent_provisioning_team").addFilter(
