...
def test_software_engineering_adapter_satisfies_protocol():
    from agent_team_studio.user_agent_founder.targets import (
...
def test_start_from_spec_hits_correct_endpoint():
    from agent_team_studio.user_agent_founder.targets import SoftwareEngineeringAdapter
...
def test_start_from_spec_raises_on_http_error():
    from agent_team_studio.user_agent_founder.targets import SoftwareEngineeringAdapter, StartFailed
