...
Team-specific HTTP coupling lives in ``agent_team_studio.user_agent_founder.targets``;
...
from agent_team_studio.user_agent_founder.store import FounderRunStore
from agent_team_studio.user_agent_founder.targets import StartFailed, TargetTeamAdapter, get_adapter
