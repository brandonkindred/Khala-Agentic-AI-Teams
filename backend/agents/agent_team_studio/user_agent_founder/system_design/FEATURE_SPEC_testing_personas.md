...
2. `npm start` and navigate to `/agent-studio` (Stage 4 — Testing Personas). Sidebar reads **Agent Studio**. Testing Personas is accessible from the Studio stage navigation.
