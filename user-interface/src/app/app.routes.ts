...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'llm-config', component: LlmConfigDashboardComponent, data: { breadcrumb: 'LLM Provider', title: 'LLM Provider' } },
      ...
      { path: 'persona-testing', component: PersonaTestingDashboardComponent, data: { breadcrumb: 'Testing Personas', title: 'Testing Personas' } },
      { path: 'persona-testing/audit/:runId', component: PersonaTestAuditPanelComponent, data: { breadcrumb: 'Audit', title: 'Testing Personas Audit' } },
